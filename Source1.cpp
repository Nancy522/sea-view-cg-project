...
void init()
{
	...
	printf("press 'x' to slow down small boat\n");
	printf("press 'y' to slow down large boat\n");
	printf("press 'z' to move the moon upwards\n");
	printf("press 'w' to move the moon downwards\n");
	printf("press 's' to stop the boats\n");
	printf("press 'r' to restart the boats\n");
...
int main(int argc, char** argv)
{
	...
	glutAddMenuEntry("1. QUIT", 1);
	glutAddMenuEntry("2. DAY VIEW", 2);
	glutAddMenuEntry("3. NIGHT VIEW", 3);
